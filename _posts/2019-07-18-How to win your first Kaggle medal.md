...
date:       2019-07-18
author:     YC
header-img: img/kaggle_head.png
catalog: true
tags:
    - Machine learning
    - Kaggle
...
<br>
Winning a Kaggle medal is not difficult if you know all the tricks and skills that the winners used. In my case, I won a silver medal in my first Kaggle machine learning competition and ranked 100th among 8800 teams without a data science degree. This blog will guide you through the whole process of a Kaggle competition and help you to win a medal, including the strategies that almost everyone uses to win the prize and a checklist for you when you are out of ideas during the competition.
...
(5) Remove noise  
Visualize data to detect potential **outliers** and try to remove them to see effects (Outliers may be determined by percentile or other logics depending on your wild guess). Also you can try to **round numbers** to less decimals and see effects. Use [ceil](https://docs.scipy.org/doc/numpy-1.15.1/reference/generated/numpy.ceil.html#numpy.ceil) or [floor](https://docs.scipy.org/doc/numpy-1.15.1/reference/generated/numpy.floor.html) functions to set upper or lower limit to numbers can be another way to remove noise.  

(6) Transformation  
You can perform log transform, square, cubic, root, absolute, sin, tanh or all the other mathematical transformation to your raw data. But remember, monotonic transformation has little effect on decision tree-based algorithms (Someone says it changes the way of binning a bit but I think it is not worthy to try).  
...
### Author information
I am a PhD from Aarhus University in Denmark. I participated my first Kaggle machine learning comepetition with 8800 teams(Santander Customer Transaction Prediction) and ranked 100th in the end. If you find any mistake in the article or think something important is not mentioned, you are welcome to contact me by caiyunpeng1989@gmail.com to help more Kaggle beginners.
